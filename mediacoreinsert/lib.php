 ...
 *
 * @package   tinymce_mediacoreinsert
 * @copyright 2012 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tinymce_mediacoreinsert extends editor_tinymce_plugin {
    /** @var array list of buttons defined by this plugin */
    protected $buttons = array('mediacoreinsert');
    ...
    protected function update_init_params(array &$params, context $context,
        ...
        $added = $this->add_button_after($params, 3, 'mediacoreinsert', 'moodleemoticon', false);
        ...
        if (!$added) {
            $this->add_button_after($params, 3, 'mediacoreinsert', 'image');
        }
